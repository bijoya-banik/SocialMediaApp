          ...
          Row(
            children: [
              ...
              CircleAvatar(
                ...
                child: Icon(FlutterIcons.check_faw, size: 15, color: KColor.white),
              ),
              ...
              CircleAvatar(
                ...
                child: Icon(FlutterIcons.check_faw, size: 15, color: _index == 0 ? KColor.grey : KColor.white),
              ),
              SizedBox(width: KSize.getWidth(context, 5)),
          ...
          Expanded(
            child: PageView.builder(
              itemBuilder: (context, position) {
                print('pos $position');
                return position == 0 ? CreateAdDetailsView() : CreateAdMediaView();
              },
              ...
              children: [
                InkWell(
                  ...
                  child: Row(
                    children: [
                      Icon(
                        FlutterIcons.arrow_long_left_ent,
                        size: 20,
                        color: KColor.black,
                      ),
                      SizedBox(width: KSize.getWidth(context, 5)),
