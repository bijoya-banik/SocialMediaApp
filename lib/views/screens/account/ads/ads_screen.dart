...
import 'package:social/views/screens/account/ads/create_ad_screen.dart';
import 'package:social/views/screens/account/ads/tabs/ad_policy_tab.dart';
import 'package:social/views/screens/account/ads/tabs/campaigns_tab.dart';
import 'package:social/views/screens/account/ads/tabs/wallet_tab.dart';
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              onPressed: () {
                Navigator.of(context, rootNavigator: true).push(CupertinoPageRoute(fullscreenDialog: true, builder: (context) => CreateAdScreen()));
              },
